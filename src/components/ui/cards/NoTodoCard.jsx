...
export default function NoTodoCard() {
    return(
        <div className="max-w-screen-md w-full text-black p-6 bg-white border-[1px] rounded-lg flex flex-col justify-center items-center">
            ...
            <img src={cat} alt="This is a happy cat to pat!" className="w-40 sm:w-1/3 mb-1"/>
        </div>
    );
}